	...
	<div align="center">
        ...
        <table>
			<tr>
				...
				<td align="left">：<input type="text" name ="pro_id" maxlength="15" value="<%=session.getAttribute("pro_id") %>"></td>
			...
			<tr>
				...
				<td align="left">:<input type="text" name ="sp_id" maxlength="6" value="<%=session.getAttribute("sp_id") %>"></td>
				<td align="left"><font color="red">
					<%if(request.getAttribute("errmsg1")!=null){ %>
						<%= request.getAttribute("errmsg1")%><br>
					<% } %>
					...
					<%if(request.getAttribute("errmsg4")!=null){ %>
						<%= request.getAttribute("errmsg4")%><br>
					<% } %>
				</font></td>
			</tr>
			<tr>
				...
				<td align="left">:<input type="text" name ="pi_id" maxlength="20" value="<%=session.getAttribute("pi_id") %>"></td>
				<td align="left"><font color="red">
					<%if(request.getAttribute("errmsg1")!=null){ %>
						<%= request.getAttribute("errmsg1")%><br>
					<% } %>
			...
			<tr>
				...
				<td align="left">:<input type="text" name ="pi_name" maxlength="400" value="<%=session.getAttribute("pi_name") %>"></td>
				<td align="left"><font color="red">
					<%if(request.getAttribute("errmsg1")!=null){ %>
						<%= request.getAttribute("errmsg1")%><br>
					<% } %>
			...
			<tr>
				...
				<td align="left">:<input type="text" name ="jan_code" maxlength="10" value="<%=session.getAttribute("jan_code") %>"></td>
			</tr>
			<tr>
				<td></td>
				<td align="left">商品管理枝番号</td>
				<td align="left">:<input type="text" name ="branch_no" maxlength="100" value="<%=session.getAttribute("branch_no") %>"></td>
				<td align="left"><font color="red">
				</font></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td align="left">:<input type="text" name ="ref_type" maxlength="3" value="<%=session.getAttribute("ref_type") %>"></td>
				<td align="left"><font color="red">
					<%if(request.getAttribute("errmsg1")!=null){ %>
						<%= request.getAttribute("errmsg1")%><br>
					<% } %>
			...
			<tr>
				...
				<td align="left">:<input type="text" name ="shipping_term" maxlength="100" value="<%=session.getAttribute("shipping_term") %>"></td>
			</tr>
			<tr>
				<td></td>
				<td align="left">商品画像1</td>
				<td align="left">:<input type="text" name ="image_1" maxlength="20" value="<%=session.getAttribute("image_1") %>"></td>
			</tr>
			<tr>
				<td></td>
				<td align="left">商品画像2</td>
				<td align="left">:<input type="text" name ="image_2" maxlength="20" value="<%=session.getAttribute("image_2") %>"></td>
			</tr>
			<tr>
				<td></td>
				<td align="left">商品画像3</td>
				<td align="left">:<input type="text" name ="image_3" maxlength="20" value="<%=session.getAttribute("image_3") %>"></td>
			</tr>
			<tr>
				<td></td>
				<td align="left">商品画像4</td>
				<td align="left">:<input type="text" name ="image_4" maxlength="20" value="<%=session.getAttribute("image_4") %>"></td>
			</tr>
			<tr>
				<td></td>
				<td align="left">商品画像5</td>
				<td align="left">:<input type="text" name ="image_5" maxlength="20" value="<%=session.getAttribute("image_5") %>"></td>
			</tr>
			<tr>
				<td></td>
				<td align="left">商品画像6</td>
				<td align="left">:<input type="text" name ="image_6" maxlength="20" value="<%=session.getAttribute("image_6") %>"></td>
			</tr>
			<tr>
				<td></td>
				<td align="left">商品画像7</td>
				<td align="left">:<input type="text" name ="image_7" maxlength="20" value="<%=session.getAttribute("image_7") %>"></td>
			</tr>
			<tr>
				<td></td>
				<td align="left">商品画像8</td>
				<td align="left">:<input type="text" name ="image_8" maxlength="20" value="<%=session.getAttribute("image_8") %>"></td>
			</tr>
			<tr>
				<td></td>
				<td align="left">商品画像9</td>
				<td align="left">:<input type="text" name ="image_9" maxlength="20" value="<%=session.getAttribute("image_9") %>"></td>
			</tr>
			<tr>
				<td></td>
				<td align="left">商品画像10</td>
				<td align="left">:<input type="text" name ="image_10" maxlength="20" value="<%=session.getAttribute("image_10") %>"></td>
			</tr>
			<tr>
				<td></td>
