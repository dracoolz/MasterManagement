...
public class CheckControlServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if(request.getParameter("type").equals("user")) {
		...
		}else if(request.getParameter("type").equals("category") && request.getParameter("maker").equals("bc")) {
		...
		}else if(request.getParameter("type").equals("product")) {
			...
			if(request.getParameter("submit").equals("登録")){
				...
				int bc_id_1 = Integer.parseInt((String)session.getAttribute("bc_id_1"));
				int sc_id_1 = Integer.parseInt((String)session.getAttribute("sc_id_1"));
				int bc_id_2 = Integer.parseInt((String)session.getAttribute("bc_id_2"));
				int sc_id_2 = Integer.parseInt((String)session.getAttribute("sc_id_2"));
				int bc_id_3 = Integer.parseInt((String)session.getAttribute("bc_id_3"));
				int sc_id_3 = Integer.parseInt((String)session.getAttribute("sc_id_3"));
				...
				int branch_no = Integer.parseInt((String)session.getAttribute("branch_no"));
				String itemization = (String)session.getAttribute("itemization");
				String ref_type = (String)session.getAttribute("ref_type");
				int retail_price = Integer.parseInt((String)session.getAttribute("retail_price"));
				...
				char[] image_permission = (char[])session.getAttribute("image_permission");
				char[] sell_permission = (char[])session.getAttribute("sell_permission");
				char[] auction_permission = (char[])session.getAttribute("auction_permission");
				char[] direct_permission = (char[])session.getAttribute("direct_permission");
				char[] out_of_stock = (char[])session.getAttribute("out_of_stock");
				...
				String pro_id = (String)session.getAttribute("pro_id");
				String new_pro_id = (String)session.getAttribute("new_pro_id");
				int sp_id = Integer.parseInt((String)session.getAttribute("sp_id"));
				int new_sp_id = Integer.parseInt((String)session.getAttribute("new_sp_id"));
				String pi_id = (String)session.getAttribute("pi_id");
				String new_pi_id = (String)session.getAttribute("new_pi_id");
				String pi_name = (String)session.getAttribute("pi_name");
				int sc_id_1 = Integer.parseInt((String)session.getAttribute("sc_id_1"));
				int sc_id_2 = Integer.parseInt((String)session.getAttribute("sc_id_2"));
				int sc_id_3 = Integer.parseInt((String)session.getAttribute("sc_id_3"));
				int new_sc_id_1 = Integer.parseInt((String)session.getAttribute("new_sc_id_1"));
				int new_sc_id_2 = Integer.parseInt((String)session.getAttribute("new_sc_id_2"));
				int new_sc_id_3 = Integer.parseInt((String)session.getAttribute("new_sc_id_3"));
				String shop_name = (String)session.getAttribute("shop_name");
				String descr = (String)session.getAttribute("descr");
				String detail = (String)session.getAttribute("detail");
				String jan_code = (String)session.getAttribute("jan_code");
