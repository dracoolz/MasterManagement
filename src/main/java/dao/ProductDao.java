...
public class ProductDao extends DBAccess{
	...
	public ArrayList<ProductBean> selectAll() {
		...
		String sql = "select p.pro_id, p.sp_id, p.pi_id, p.pd_id, pi.pi_name, bc.bc_category as bc_category1, sc.sc_id, sc.sc_category as sc_category1, bc.bc_category, sc.sc_category, bc.bc_category, sc.sc_category, sup.shop_name, pd.descr, pd.detail, pi.jan_code, p.branch_no, p.itemization, pi.ref_type, pi.retail_price, p.wholesale, p.set_quantity, pi.tax_rate_class, pi.shipping_term, pimg.images_id, pimg.image_1, pimg.image_2, pimg.image_3, pimg.image_4, pimg.image_5, pimg.image_6, pimg.image_7, pimg.image_8, pimg.image_9, pimg.image_10, p.image_permission, p.sell_permission, p.auction_permission, p.direct_send, p.out_of_stock, c.category_id "
				...
				+ "where p.pi_id = pi.pi_id and p.pd_id = pd.pd_id and p.images_id = pimg.images_id and p.sp_id = sup.sp_id and pi.category_id = c.category_id and c.sc_id = sc.sc_id and sc.bc_id = bc.bc_id order by p.pro_id;";
		try {
			connect();
			// ステートメントの作成
			...
			while (rs.next()) {
				...
				bean.setBc_category_1(rs.getString("bc_category1"));
				bean.setSc_category_1(rs.getString("sc_category1"));
				...
				bean.setSc_id1(rs.getInt("sc_id"));
	...
	public void insert(String pro_id, int sp_id, String pi_id, String pi_name, int bc_id_1, int sc_id_1, int bc_id_2, int sc_id_2, int bc_id_3, int sc_id_3, String shop_name, String descr, String detail, String jan_code, String branch_no, String itemization, String ref_type, int retail_price, int wholesale, int set_quantity, int tax_rate_class, String shipping_term, String image_1, String image_2, String image_3, String image_4, String image_5, String image_6, String image_7, String image_8, String image_9, String image_10, char image_permission, char sell_permisson, char auction_permission, char direct_permission, char out_of_stock) {
		...
		String sql4 = "insert into product_images(image_1,image_2,image_3,image_4,image_5,image_6,image_7,image_8,image_9,image_10) values (?,?,?,?,?,?,?,?,?,?);";
		String sql5 = "insert into supplier(sp_id,shop_name) values (?,?);";
		...
		try {
			...
			ps.setString(1,image_1);
			ps.setString(2,image_2);
			ps.setString(3,image_3);
			ps.setString(4,image_4);
			ps.setString(5,image_5);
			ps.setString(6,image_6);
			ps.setString(7,image_7);
			ps.setString(8,image_8);
			ps.setString(9,image_9);
			ps.setString(10,image_10);
			ps.executeUpdate();
		} catch (SQLException e) {
			e.printStackTrace();
		} finally {
